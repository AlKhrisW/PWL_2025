    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button onclick="modalAction('{{ url('/level/import') }}')" class="btn btn-info btn-sm">Import Barang</button>
                <a href="{{ url('/level/export_excel') }}" class="btn btn-primary btn-sm"><i class="fa fa-file-excel"></i> Export Barang</a>
                <a href="{{ url('/level/export_pdf') }}" class="btn btn-warning btn-sm"><i class="fa fa-file-pdf"></i> Export Barang</a>
